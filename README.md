...
| :--------- | :------- | :---- | :---------------- | :----------- |
| teapot.obj | 3,241    | 6,320 | Vectorized Raster | **7.421 s**  |
| bunny.obj  | 4,200    | 8,390 | Vectorized Raster | **4.8685 s** |

_Note: Performance varies based on GPU hardware and batch size configurations._
